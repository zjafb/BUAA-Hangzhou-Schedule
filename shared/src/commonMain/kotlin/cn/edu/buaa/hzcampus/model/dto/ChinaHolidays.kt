 ...
 *
 * ⚠️ 这张表是硬编码的离线数据，**需要每年更新**：国务院办公厅一般在上一年的 11 月发布下一年的安排，
 * 届时照着新通知在 [marks] 里增删条目即可，数据结构和 UI 都不用改。
 * 表外的年份不做任何猜测（宁可不显示标记，也不显示错误标记）。
 *
 * 关于 2025 年年底：2025 年 12 月 31 日（周三）是正常工作日，2026 年元旦假期从 2026 年 1 月 1 日开始，
 * 因此这里不需要 2025 年的条目。
 */
